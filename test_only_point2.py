...
############################################################
        ...
        with torch.no_grad():
            ...
            text_features = text_features.repeat_interleave(nv,dim=0) # 9,2,768
            
            image_features, patch_features = model.encode_image(render_image, features_list, DPAM_layer = 20)
            image_features = image_features / image_features.norm(dim=-1, keepdim=True)

            image_features2, patch_features2 = model.encode_image(depth_image, args.features_list, DPAM_layer = 20)
            image_features2 = image_features2 / image_features2.norm(dim=-1, keepdim=True) # b*nv,768
