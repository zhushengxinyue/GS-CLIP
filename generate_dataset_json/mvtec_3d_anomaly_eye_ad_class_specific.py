...
class MVTecSolver(object):
    ...
    def __init__(self, root='data/mvtec', cls_id = 0):
        self.root = root
        self.CLSNAMES = [eyecandies_classes()[cls_id]]
                ...
                for specie in species:
                    ...
                    for idx, d2_img_name in enumerate(d2_img_names):
                        info_img = dict(
                            ...
                            d3_pcd_path=f'{img_path}/gt_pcd/{d2_img_name.split(".")[0]}.pcd',
...
if __name__ == '__main__':
    ...
    runner = MVTecSolver(root='/remote-home/iot_zhouqihang/data/Eyecandies_processed', cls_id = args.cls_id)
    runner.run()