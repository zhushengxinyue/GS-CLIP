...
class MVTecSolver(object):
    ...
    def __init__(self, root='data/mvtec', cls_id = 0):
        self.root = root
        self.CLSNAMES = [mvtec3d_classes()[cls_id]]
    ...
    def run(self):
        ...
        for cls_name in self.CLSNAMES:
            ...
            print('total samples', normal_samples + anomaly_samples)
if __name__ == '__main__':
    ...
    runner = MVTecSolver(root='/remote-home/iot_zhouqihang/data/mvtec_3d_mv/mvtec_3d_9_views', cls_id = args.cls_id)
    runner.run()
